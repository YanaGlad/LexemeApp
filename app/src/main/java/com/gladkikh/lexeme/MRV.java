...
public class MRV {
    public static double count_lexemes(String input, ArrayList<String> keys, ArrayList<Double> values) throws MRV_ARGUMENT_LIST_MISMATCH, MRV_UNKNOWN_FUNCTION, MRV_ERROR_SIGNS, MRV_IMPOSSIBLE_COUNT, MRV_MISS_ARGUMENT_BINARY_OPERATOR, MRV_MISS_ARGUMENT_PRE_OPERATOR, MRV_MISS_ARGUMENT_POST_OPERATOR, MRV_HAVE_OPEN_BRACKETS, MRV_MORE_RIGHT_BRACKETS, MRV_BAD_ARGUMENTS, MRV_UNKNOWN_ERROR {
